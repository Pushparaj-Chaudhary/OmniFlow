...
// Task Mentor Routes
export const onboardTaskMentor = (data) => api.post('/taskmentor/onboard', data);
export const getTaskMentorRoadmap = () => api.get('/taskmentor/roadmap');
export const saveTaskMentorRoadmap = (data) => api.post('/taskmentor/roadmap', data);
export const deleteTaskMentorRoadmap = () => api.delete('/taskmentor/roadmap');
export const getTaskMentorTodayTask = () => api.get('/taskmentor/tasks/today');
export const saveTaskMentorTask = (data) => api.post('/taskmentor/tasks', data);
export const updateTaskMentorStatus = (id, status) => api.post(`/taskmentor/tasks/${id}/status`, { status });
export const getTaskMentorHistory = () => api.get('/taskmentor/tasks/history');
export const getTaskMentorNotifications = () => api.get('/taskmentor/notifications');

// AI Routes overrides / specific usage
export const aiGenerateRoadmap = (data) => api.post('/ai/generate-roadmap', data);
export const aiGenerateTask = (data) => api.post('/ai/generate-task', data);
