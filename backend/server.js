...
import taskMentorRoutes from './routes/taskMentorRoutes.js';
import { startTaskMentorCron } from './cron/taskMentorCron.js';
...
app.use('/api/taskmentor', taskMentorRoutes);

// Initialize Reminder Cron Job
startCron();
// Initialize Task Mentor Cron Job
startTaskMentorCron();
